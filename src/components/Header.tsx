...
const socialLinks = [
  {
    name: 'Twitter',
    href: 'https://x.com/Zap_launch_SOL',
    icon: (
  ...
  {
    name: 'Gitbook',
    href: 'https://zap-launch.gitbook.io/docs',
    icon: (
...
export default function Header() {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-50 w-full border-b border-white/10 bg-black/50 backdrop-blur-sm transition-transform duration-300 ease-in-out ${
      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <a 
              href="#hero"
              className="flex items-center space-x-3 text-xl sm:text-2xl font-black text-white tracking-tight hover:text-white/80 transition-colors duration-200"
              onClick={closeMenu}
            >
              <Image
                src="/logo.png"
          ...
          <nav className="hidden md:flex items-center">
            <div className="flex items-center space-x-6 lg:space-x-8 mr-6 lg:mr-8">
              <a
                href="#steps"
                className="text-white/80 hover:text-white transition-colors duration-200 font-normal text-sm lg:text-base"
              >
                How it Works
              </a>
              <a
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'} overflow-hidden`}>
          <div className="py-4 space-y-4 border-t border-white/10">
            <a
              href="#steps"
              className="block text-white/80 hover:text-white transition-colors duration-200 font-normal py-2"
              onClick={closeMenu}
            >
              How it Works
            </a>
            ...
            {/* Mobile Social Links */}
            <div className="flex items-center space-x-5 pt-4 border-t border-white/10">
              {socialLinks.map((link) => (
                link.href ? (
                  <a 
                    key={link.name}
