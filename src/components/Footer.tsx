      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-start">
            <a 
              href="#hero"
              className="flex items-center space-x-3 text-xl font-black text-white tracking-tight hover:text-white/80 transition-colors duration-200 mb-4"
            >
              <Image
                src="/logo.png"
                alt="Zap.launch Logo"
            ...
            <p className="text-white/60 text-sm leading-relaxed max-w-sm">
              Launch tokens and NFTs directly from social content. The first platform to bridge social media and DeFi.
            </p>
          </div>
            ...
            <div className="flex items-center space-x-4">
              {socialLinks.map((link) => (
                link.href ? (
                  ...
                  <span 
                    key={link.name}
                    className="text-white/30 p-2 rounded-lg cursor-not-allowed"
        ...
        <div className="border-t border-white/10 pt-6">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-3 sm:space-y-0">
            ...
            <p className="text-white/50 text-sm">
              © {currentYear} Zap.launch. All rights reserved.
            </p>
